package com.dahai.mvpdemo.google.data;
...
public class Task {
    ...
    /**
     *  use this constructor to create a new activie Task.
    ...
    /**
     *  Use this constructor to specify a completed task if hte task already has an id
     * @param title
     * @param description
     * @param id
     * @param completed
